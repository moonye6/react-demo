...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactApp = React.createFactory(__webpack_require__(164));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(154);
	var ReactTransitionGroup = __webpack_require__(155);
	var ReactUpdates = __webpack_require__(30);

	var cx = __webpack_require__(161);
	var cloneWithProps = __webpack_require__(157);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(163);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRootIndex = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecated = __webpack_require__(73);
	var getReactRootElementInContainer = __webpack_require__(74);
	var instantiateReactComponent = __webpack_require__(44);
	var invariant = __webpack_require__(10);
	var shouldUpdateReactComponent = __webpack_require__(48);
	var warning = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMSelection = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNodeForCharacterOffset = __webpack_require__(93);
	var getTextContentAccessor = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(112);
	var getMarkupWrap = __webpack_require__(114);
	var invariant = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(7);
	var ReactTransitionChildMapping = __webpack_require__(156);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var CCard1 = __webpack_require__(165);
	var CBar = __webpack_require__(169);
	...
	var ReactApp = React.createClass({displayName: "ReactApp",
		...
		render: function() {
			...
			var createCards = function(item) {
				return React.createElement(Card1, null);
			};
			var createCards3 = function(item) {
				return React.createElement(Card3, null);
			};

			//var x = items.map(createCards);
			return (React.createElement("div", {className: "container"}, 
						React.createElement(CBar, {indexs: "xx", tt: ids, id: "menu"}), 
						React.createElement(CCard1, {id: "test1"}), 
						React.createElement(CCard1, {id: "test2"}), 
						React.createElement(CCard1, {id: "test3"})
					));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Card1 = __webpack_require__(166);
	var Card2 = __webpack_require__(167);
	var Card3 = __webpack_require__(168);

	var ComCard1 = React.createClass({displayName: "ComCard1",
		...
		render: function() {
			...
			//var x = items.map(createCards);
			return (React.createElement("div", {className: "comcard1 clearfix", id: this.props.id}, 
						React.createElement("h4", {className: "comcard1-title1"}, React.createElement("i", null), "韩语课"), 
						React.createElement("h5", {className: "comcard1-title2"}, "快来吧思密达，跟着欧巴学韩语，以后看韩剧再也不需要字幕啦！"), 
	...
	var Card1 = React.createClass({displayName: "Card1",
		...
		render: function() {
			...
			return (React.createElement("div", {className: "course"}, 
						React.createElement("a", {className: "course-link", href: "http://www.baidu.com/", target: "_blank"}, 
							React.createElement("img", {className: "course-link-img", src: cover})
						), 
						React.createElement("a", {className: "course-name", href: "http://www.baidu.com/", target: "_blank"}, name)
					));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card2 = React.createClass({displayName: "Card2",
		...
		render: function() {
			...
			var price ="免费"
			var agency ="蓝轨迹"
			return (React.createElement("div", {className: "course-big clearfix"}, 
						React.createElement("a", {className: "course-link", href: "http://www.baidu.com/", target: "_blank"}, 
							React.createElement("img", {className: "course-link-img", src: cover})
						), 
						React.createElement("div", {className: "course-right"}, 
							React.createElement("a", {className: "course-name", href: "http://www.baidu.com/", target: "_blank"}, name), 
							React.createElement("p", {className: "course-info"}, 
								React.createElement("span", {className: "course-price course-price-free"}, price), 
								React.createElement("span", {className: "course-sep"}), 
								React.createElement("a", {className: "course-agency", href: "http://www.baidu.com/", target: "_blank"}, agency)
							)
						)
					));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card3 = React.createClass({displayName: "Card3",
		...
		render: function() {
			...
			var price ="免费"
			var agency ="蓝轨迹"
			return (React.createElement("div", {className: "course-middle clearfix"}, 
						React.createElement("a", {className: "course-link", href: "http://www.baidu.com/", target: "_blank"}, 
							React.createElement("img", {className: "course-link-img", src: cover})
						), 
						React.createElement("div", {className: "course-right"}, 
							...
							React.createElement("p", {className: "course-info"}, 
								React.createElement("span", {className: "course-price course-price-free"}, price), 
								React.createElement("span", {className: "course-sep"}), 
								React.createElement("span", {className: "course-agency"}, agency)
							)
						)
					));
		}
	...
	var Bar = React.createClass({displayName: "Bar",
		...
		render: function() {
			var itemTag = function(item) {
				var t = '#'+item;
				return React.createElement("li", {className: "nav-item"}, React.createElement("a", {href: t}, item))
			}
			return (React.createElement("ul", {className: "nav clearfix", id: "menu"}, 
